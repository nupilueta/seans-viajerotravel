...
const DEFAULT_SERVICE_TYPES = ['Visa Processing', 'Airline Ticket', 'Tour Package', 'Hotel Booking', 'Travel Insurance', 'Receipt', 'Credit Card Payment', 'Customer Booking', 'Customer Inquiries', 'Partner Coordination', 'Flight Reservation', 'Other'];
